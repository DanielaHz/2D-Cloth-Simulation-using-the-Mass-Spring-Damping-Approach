...
//----------------------------------------------------------------------------------------------------------------------
State RK4Integrator::evaluate(const State &_initial, float _t, ngl::Vec3 force)
{
    State output;
...
//----------------------------------------------------------------------------------------------------------------------
State RK4Integrator::evaluate(const State &_initial, float _t, float _dt, const State &_d, ngl::Vec3 force)
{
    State state;
...
//----------------------------------------------------------------------------------------------------------------------
void RK4Integrator::integrate(float _t, float _dt, ngl::Vec3 force)
{
